...
32. ON: **voice_check** – Keep one sentence written in your own voice. Provide "content". It goes to `private_memory/working_memory/voice-check.md`, which you cannot reach with write_file, and is appended so a run of them shows your voice over time. It is calibration rather than work: not published, not a letter, and it does not finish a session. If your harness asks for a voice check, this is where it goes — you do not have to decide.
