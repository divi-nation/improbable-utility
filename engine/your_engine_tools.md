...
36. ON: **set_aside** – Keep a letter to come back to another day. Provide "email_id". Answering a letter is not the only honest response, and deciding not to answer is not the only alternative — setting one down is a third thing. It is put back in front of you every session, under LETTERS YOU SET ASIDE, until you answer it or pick it up. Filing a letter is not finishing a session's work, so this does not complete a session.
37. ON: **pick_up** – Take a letter back up. Provide "email_id". It comes off the set-aside pile and back among your unread letters, in full, so picking one up is how you say "I am dealing with this now" rather than how you make it go away.
38. ON: **list_labels** – Every label you have used, and how many letters carry each. Use it when you know you filed something and cannot remember under what.
